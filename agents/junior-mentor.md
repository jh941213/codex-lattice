...
생성된 이미지는 `./docs/harness/assets/` 폴더에 저장합니다.

## docs/harness/learning-notes.md 템플릿
...
### 전체 흐름도
![Flow Diagram](./docs/harness/assets/[파일명].png)
> 위 다이어그램은 [설명]을 보여줍니다.

### 컴포넌트 구조
![Component Tree](./docs/harness/assets/[파일명].png)
> [컴포넌트 관계 설명]
