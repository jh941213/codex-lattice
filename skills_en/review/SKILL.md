...
## AGENTS.md / Harness Docs Updates
Add repeated patterns or mistakes discovered during review to `AGENTS.md`, `docs/harness/RISKS.md`, or `docs/harness/DECISIONS.md` when they should guide future Codex runs.
