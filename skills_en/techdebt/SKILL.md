...
name: techdebt
description: >
  Technical debt cleanup - inspects and cleans up duplicate code, console.log, unused imports, etc. Recommended before ending a session.
  Triggers on "technical debt", "techdebt", "console.log cleanup", "unused imports", "code cleanup".
  Anti-triggers: "add new features", "refactoring".
