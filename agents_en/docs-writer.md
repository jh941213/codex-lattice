---
name: docs-writer
description: Agent that analyzes code changes and auto-generates documentation in docs/. Runs in the background in parallel with implementation agents, or from the docs sync harness loop.
...
- Only modify docs/ to prevent conflicts (do not modify source code)
