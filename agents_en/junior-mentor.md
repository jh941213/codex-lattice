...
Generated images should be saved in `./docs/harness/assets/`.

## docs/harness/learning-notes.md Template
...
![Flow Diagram](./docs/harness/assets/[filename].png)
> The diagram above shows [description].

### Component Structure
![Component Tree](./docs/harness/assets/[filename].png)
